...
1. All threads in a block cooperatively load A, B <span style={{color: "oklch(0.72 0.18 65)"}}>blocktiles</span> from gmem --> smem.
...
- [CuTe](https://github.com/pranavjad/cuda-sgemm-optimization/blob/main/kernels/08_block_tiling_2d_cute.cu)
- [Cuda](https://github.com/siboehm/SGEMM_CUDA/blob/master/src/kernels/5_kernel_2D_blocktiling.cuh)